...
const Products = () => {
  return (
    <main className='w-full bg-white mt-[80px] pb-[320px] px-[135px] text-black'>
        <div className='flex items-center justify-between'>
            <h2 className='text-[20px] font-[400] leading-[26px]'>Products</h2>
            <button className='bg-transparent w-[223px] h-[56px] border-1 border-[#00000080] rounded-[4px]'>Move All To Bag</button>
        </div>
        <div className='mt-[60px] flex flex-wrap justify-between gap-[30px]'>
            {
